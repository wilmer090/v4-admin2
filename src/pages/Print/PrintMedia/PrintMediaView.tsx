...
import PrintMedia_Columns from './PrintMediaColumn';
...
const PrintMediaView: React.FC<Props> = ({ data, handlePageChange, page, handlePageSize }) => {
      ...
      <Card $fullHeight>
        ...
        <TableContainer>
          <Table
            // loading={isLoading}
            data={data}
            columns={PrintMedia_Columns({ handleEdit })}
            pagination={{
              current: page,
