...
import PrintAds_Columns from './PrintAdsColumn';
...
const PrintAdsView: React.FC<Props> = ({ data, handlePageChange, page, handlePageSize }) => {
      ...
      <Card $fullHeight>
        ...
        <TableContainer>
          <Table
            // loading={isLoading}
            data={data}
            columns={PrintAds_Columns({ handleEdit })}
            pagination={{
              current: page,
