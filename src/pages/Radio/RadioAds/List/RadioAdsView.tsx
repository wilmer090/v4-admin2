...
import RadioClip_Columns from '../../RadioClips/List/RadioClipColumn';
...
const RadioAdsView: React.FC<Props> = ({ data, handlePageChange, page, handlePageSize }) => {
